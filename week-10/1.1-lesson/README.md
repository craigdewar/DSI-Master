...
Let's perform a simple map-reduce in the class, let's find the 10 most common words in the paragraph below. Break into four groups and count occurances of key words in each section:
